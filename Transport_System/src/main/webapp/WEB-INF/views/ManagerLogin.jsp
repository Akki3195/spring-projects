		...
		<div class="container-login100" style="background-image: url('${pageContext.request.contextPath}/resources/image/TransportTruck.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form:form class="login100-form validate-form p-b-33 p-t-5" 
							method="POST" action="loginSuccessfull" modelAttribute="mgrLoginDtl">

					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<form:input class="input100" type="text" path="MGR_USER_ID" placeholder="User name"/>
						<span class="focus-input100" data-placeholder="&#xe82a;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<form:input class="input100" type="password" path="MGR_PASSWORD" placeholder="Password"/>
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>
